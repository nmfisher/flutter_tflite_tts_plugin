...
abstract class Preprocessor {
  List<int> textToSequence(String text, {List<String>? pronunciation});
}

class Baker extends Preprocessor {
  late Map<String, dynamic> _mapper;
  late int _eosId;

  Baker() {
    _mapper = json.decode(_MAPPERSTRING);
  ...
  List<int> textToSequence(String text, {List<String>? pronunciation}) {
    var phonemes = getPhoneme(text, pronunciation!);
